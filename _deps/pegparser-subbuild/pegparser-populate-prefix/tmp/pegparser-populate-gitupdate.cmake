...
if("${show_ref_output}" MATCHES "refs/remotes/v2.0")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "v2.0")
...
# yet).
execute_process(
  COMMAND "/usr/bin/git" rev-list --max-count=1 v2.0
  WORKING_DIRECTORY "/workspaces/social-gaming2/social-gaming/_deps/pegparser-src"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'https://github.com/TheLartians/PEGParser.git'")
  endif()
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/workspaces/social-gaming2/social-gaming/_deps/pegparser-src/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/workspaces/social-gaming2/social-gaming/_deps/pegparser-src/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
